...
const translations: Record<Lang, Record<string, TranslationValue>> = {
  zh: {
    ...
    invalid_url_format: '链接格式错误：仅支持 Apple Music 链接（music.apple.com）',
    no_tasks: '暂无下载任务',
    ...
    cookies_recheck: '正在验证 cookies...',
    cookies_recheck_failed: 'Cookies 验证失败，请重新检测后再下载',
    select_codec_title: '选择音频编码',
    select_codec_desc: '当前设置为「每次询问」，请选择本次下载使用的编码',
    confirm_codec: '确认并下载',
    loading_logs: '正在加载日志...',
    copy_logs: '复制日志',
    logs_copied: '已复制',
  ...
  en: {
    ...
    invalid_url_format: 'Invalid URL format: Only Apple Music links (music.apple.com) are supported',
    ...
    cookies_recheck: 'Verifying cookies...',
    cookies_recheck_failed: 'Cookies verification failed. Please re-check before downloading.',
    select_codec_title: 'Select Audio Codec',
    select_codec_desc: 'Codec is set to "Ask Each Time". Choose a codec for this download.',
    confirm_codec: 'Confirm & Download',
